      ...
      <main className="pt-32 pb-32 min-h-screen bg-[#0A1020]">
        <div className="max-w-3xl mx-auto px-4">
          ...
          <div className="text-center mb-24">
            <h1 className="bg-gradient-to-r from-[#7F5AF0] to-[#00FFC2] bg-clip-text text-transparent mb-4 text-4xl sm:text-5xl font-extrabold font-display">📄 Terms and Conditions</h1>
            <p className="text-[#9CA3AF] text-lg mb-2 leading-relaxed">Please read these terms carefully before using our services.</p>
